...
class ChangePasswordTestDT(TestCase):
    ...
    def __init__(self):
        self.test_case_data = [
            ...
            {
                'name': 'test_case_failed_invalid_current_password_valid_confirm_password',
            ...
            {
                'name': 'test_case_failed_invalid_current_password_invalid_confirm_password',
                "current_password": "admin",
                "new_password": "1234",
                "confirm_password": "123456",
                'xpath': ['//*[@id="id_error_password"]'],
            ...
            {
                'name': 'test_case_failed_invalid_current_password_empty_confirm_password',
                "current_password": "admin",
                "new_password": "1234",
                "confirm_password": "",
                'xpath': ['//*[@id="id_error_newpassword2"]'],
            ...
            {
                'name': 'test_case_failed_invalid_current_password_empty_new_password_box',
                "current_password": "admin",
                "new_password": "",
                "confirm_password": "abc",
                'xpath': ['//*[@id="id_error_newpassword1"]'],
            ...
            {
                'name': 'test_case_failed_empty_current_password_non_empty_new_password_valid_confirm_password',
                "current_password": "",
                "new_password": "1234",
                "confirm_password": "1234",
                'xpath': ['//*[@id="id_error_password"]'],
            ...
            {
                'name': 'test_case_failed_empty_current_password_non_empty_new_password_invalid_confirm_password',
                "current_password": "",
                "new_password": "1234",
                "confirm_password": "123456",
                'xpath': ['//*[@id="id_error_password"]'],
            ...
            {
                'name': 'test_case_failed_empty_current_password_non_empty_new_password_empty_confirm_password',
                "current_password": "",
                "new_password": "1234",
                "confirm_password": "",
                'xpath': ['//*[@id="id_error_password"]'],
            ...
            {
                'name': 'test_case_failed_empty_current_password_empty_new_password',
                "current_password": "",
                "new_password": "",
                "confirm_password": "12",
                'xpath': ['//*[@id="id_error_password"]'],
